...
const servicePoints = [
  ...
  {
    title: 'חיסכון כספי ללקוח:',
    desc: 'חיסכון רב בהוצאות נלוות כגון: הדפסת פלוטים צבעוניים במכוני "העתקות אור", שליחת התשריטים פיזית ממקום למקום ע"י שליחויות ו/או בדואר וכיוצ"ב. התשריט הינו דיגיטלי מא\' ועד ת\', כולל הגשתו לרשויות, מה שחוסך את כל סחבת ההדפסות היקרה והמיותרת.'
  },
  {
    title: 'בדיקה מהירה ואישור מהיר של התשריט:',
    desc: 'התשריט הדיגיטלי בנוהל אחיד נבדק דיגיטלית ע"י מערכת ממוחשבת. במידה וישנן שגיאות, המערכת שולחת אלינו "פלט שגיאות" לתיקון עד שהתשריט עובר בדיקה מלאה תקינה של כל הדירות, ההצמדות ונתוני התשריט, מה שמונע עיכובים מיותרים עקב דחיית התשריט או החזרתו לתיקון ע"י לשכות המקרקעין.'
  },
  {
    title: 'מתן עדיפות ובדיקה מהירה של התשריט ע"י לשכות המקרקעין:',
    desc: 'התשריט הדיגיטלי מקבל עדיפות ראשונה בכל מה שקשור לבדיקת התשריט ע"י פקידי לשכות המקרקעין, מה שחוסך זמן רב ועיכובים מיותרים, לפעמים של חודשים רבים.'
  }
];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-200 text-[22px] leading-relaxed font-normal bg-brand-gray-dark/60 p-8 rounded-sm border border-white/5 text-center">
              חברתנו מתמחה בעריכת תשריטים דיגיטליים לצורך רישום בתים משותפים בטאבו, עפ"י הנוהל האחיד החדש לעריכת תשריטים של לשכות רישום המקרקעין, והגשתם הדיגיטלית מתבצעת באמצעות המערכת החדשה הנקראת "מערכת רימון". לתשריטים הדיגיטליים במתכונת הנוהל האחיד ישנם יתרונות רבים וגדולים, כמפורט להלן:
            </p>
